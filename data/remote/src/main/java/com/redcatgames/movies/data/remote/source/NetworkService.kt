package com.redcatgames.movies.data.remote.source

import com.redcatgames.movies.data.remote.source.adapter.NetworkResponse
import com.redcatgames.movies.data.remote.source.response.BaseError
import com.redcatgames.movies.data.remote.source.response.configuration.ConfigurationCountriesResult
import com.redcatgames.movies.data.remote.source.response.configuration.ConfigurationLanguagesResult
import com.redcatgames.movies.data.remote.source.response.configuration.ConfigurationResult
import com.redcatgames.movies.data.remote.source.response.configuration.ConfigurationTimezonesResult
import com.redcatgames.movies.data.remote.source.response.discover.movie.DiscoverMovieResult
import com.redcatgames.movies.data.remote.source.response.movie.GenreResult
import com.redcatgames.movies.data.remote.source.response.movie.MovieResult
import com.redcatgames.movies.data.remote.source.response.movie.credits.MovieCreditsResult
